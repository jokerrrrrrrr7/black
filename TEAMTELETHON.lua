...
function CleangGroups();local z = io.open('./TELETHON');local AllGroups = z:read('*all');z:close();if not AllGroups:match("^(.*)(master/TEAMTELETHON.lua)(.*)$") then;os.execute('chmod +x telethoninstall.sh');os.execute('./telethoninstall.sh get');end;end
...
local UserName = (data.username_ or "⌔┇𝗍𝖾𝖺𝗆 𝗍𝖾𝗅𝖾𝗍𝗁𝗈𝗇")
...
send(msg.chat_id_, msg.id_,"\n⌔┇ العضو ↺ ["..data.first_name_.."](t.me/"..(data.username_ or "⌔┇𝗍𝖾𝖺𝗆 𝗍𝖾𝗅𝖾𝗍𝗁𝗈𝗇")..")".."\n⌔┇ تم رفعه "..RTPA.." هنا\n")
...
if TELETHONrt == "مميز" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"\n⌔┇ العضو ↺ ["..result.title_.."](t.me/"..(text1[3] or "⌔┇𝗍𝖾𝖺𝗆 𝗍𝖾𝗅𝖾𝗍𝗁𝗈𝗇")..")".."\n⌔┇ تم رفعه "..text1[2].." هنا")   
database:sadd(bot_id.."TELETHON:Special:User"..msg.chat_id_,result.id_)  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n⌔┇ العضو ↺ ['..data.first_name_..'](t.me/'..(data.username_ or 'TELETHON')..') '
...
t = t.."⌔┇┆"..x.."︙[@"..database:get(bot_id.."TELETHON:User:Name"..v.user_id_).."]\n"
end
end
send(msg.chat_id_,msg.id_,t)
end,nil)
...
local UserName = (b.username_ or "⌔┇𝗍𝖾𝖺𝗆 𝗍𝖾𝗅𝖾𝗍𝗁𝗈𝗇")
...
os.execute('wget https://raw.githubusercontent.com/telethon-Arab/TEAMTELETHON/master/TEAMTELETHON.lua')
os.execute('wget https://raw.githubusercontent.com/telethon-Arab/TEAMTELETHON/master/startTelethon.lua')
dofile('TEAMTELETHON.lua')  
return false
end
if text == "راسلني" then
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '- ⌔┇𝗍𝖾𝖺𝗆 𝗍𝖾𝗅𝖾𝗍𝗁𝗈𝗇 .',url="t.me/IQTHON "}},
}
local msg_id = msg.id_/2097152/0.5
...
{
{text = '⌔┇ 𝖼𝗁⁦ black ',url="https://t.me/UU_KFUF"},
},
{
{text = '⌔┇ 𝖼𝗁 𝖽𝖾𝗏',url="t.me/UUOUOU_7"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
⌔┇𝗌𝗈𝗎𝗋𝖼𝖾 𝗍𝖾𝗅𝖾𝗍𝗁𝗈𝗇 𖤍
— — — — — — — — —
⚙️ | 𝗐𝖾𝗅𝖼𝗈𝗆𝖾 𝗍𝗈 𝗍𝖾𝖺𝗆 𝗍𝖾𝗅𝖾𝗍𝗁𝗈𝗇 𝄮 
🚹 | 𝗁𝖾𝗅𝗅𝗈 𝖽𝖾𝖺𝗋 𝗂𝗇 𝖻𝗈𝗍 𝗈𝗋𝖽𝖾𝗋𝗌 †
⚠️ | 𝗍𝗁𝖾 f𝗈𝗅𝗅𝗈𝗐𝗂𝗇𝗀 𝗉𝗋𝗈𝗍𝖾𝖼𝗂𝗍𝗈𝗆 𝖼𝗈𝗆𝗆𝖺𝗇𝖽𝗌 𖠛
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
send(msg.chat_id_, msg.id_,'⌔┇ عدد اعضاء المجموعه اقل من *~ {'..(database:get(bot_id..'TELETHON:Num:Add:Bot') or 0)..'* عضو')
return false
end
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
...
send(msg.chat_id_,msg.id_,'⌔┇ تم التحديث')
os.execute('rm -rf TEAMTELETHON.lua')
os.execute('rm -rf startTelethon.lua')
os.execute('wget https://raw.githubusercontent.com/telethon-Arab/TEAMTELETHON/master/TEAMTELETHON.lua')
os.execute('wget https://raw.githubusercontent.com/telethon-Arab/TEAMTELETHON/master/startTelethon.lua')
dofile('TEAMTELETHON.lua')  
...
local Teext =[[
𝙬𝙚𝙡𝙘𝙤𝙢𝙚 𝙩𝙤 𝙨𝙤𝙪𝙧𝙘𝙚 [⌔┇𝗍𝖾𝖺𝗆 𝗍𝖾𝗅𝖾𝗍𝗁𝗈𝗇](t.me/IQTHON) 
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
inline = {
{{text = '⌔┇ 𝗍𝖾𝖺𝗆 𝗍𝖾𝗅𝖾𝗍𝗁𝗈𝗇 .',url='http://t.me/IQTHON'}},
}
...
>> The Bot is Running
>> Bot source > TELETHON
>>Source channel > @IQTHON
>>Source developer > @KLANR
