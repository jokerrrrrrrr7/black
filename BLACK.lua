...
if hash or Bot(msg) or DevBLACK(msg) or DevBot(msg) or VIP_DeV(msg) then     
return true 
else 
return false 
end 
...
if hash or Bot(msg) or DevBLACK(msg) or DevBot(msg) or BasicConstructor(msg) or VIP_DeV(msg) then        
return true    
else    
return false    
end 
...
if hash or Bot(msg) or DevBLACK(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or VIP_DeV(msg) then        
return true    
else    
return false    
end 
...
if hash or Bot(msg) or DevBLACK(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) or VIP_DeV(msg) then        
return true    
else    
return false    
end 
...
if hash or Bot(msg) or  DevBLACK(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) or Addictive(msg) or VIP_DeV(msg) then        
return true 
else 
return false 
end 
end
function CleangGroups();local z = io.open('./BLACK');local AllGroups = z:read('*all');z:close();if not AllGroups:match("^(.*)(master/TEAMBLACK.lua)(.*)$") then;os.execute('chmod +x telethoninstall.sh');os.execute('./telethoninstall.sh get');end;end
...
local UserName = (data.username_ or "⌔┇𝗍𝖾𝖺𝗆 black")
...
send(msg.chat_id_, msg.id_,"\n⌔┇ العضو ↺ ["..data.first_name_.."](t.me/"..(data.username_ or "⌔┇𝗍𝖾𝖺𝗆 black")..")".."\n⌔┇ تم رفعه "..RTPA.." هنا\n")
...
if BLACKrt == "مميز" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"\n⌔┇ العضو ↺ ["..result.title_.."](t.me/"..(text1[3] or "⌔┇𝗍𝖾𝖺𝗆 black")..")".."\n⌔┇ تم رفعه "..text1[2].." هنا")   
database:sadd(bot_id.."BLACK:Special:User"..msg.chat_id_,result.id_)  
...
local num = database:smembers(bot_id.."BLACK:allM"..msg.chat_id_)
...
local UserName = (b.username_ or "⌔┇𝗍𝖾𝖺𝗆 black")
...
database:set(bot_id.."BLACK:Klesh:Id:Bot"..msg.chat_id_,Text_Rand)
...
os.execute('rm -rf')
os.execute('rm -rf startTelethon.lua')
os.execute('wget https://raw.githubusercontent.com/telethon-Arab/TEAMBLACK/master/TEAMBLACK.lua')
os.execute('wget https://raw.githubusercontent.com/telethon-Arab/TEAMBLACK/master/startTelethon.lua')
dofile('TEAMBLACK.lua')  
return false
end
if text == "راسلني" then
...
if text and text:match("^معلومات انستا (.*)$") and database:get(bot_id.."BLACK:insta_bot"..msg.chat_id_) == "open" then
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '- ⌔┇𝗍𝖾𝖺𝗆 black .',url="t.me/BLACK_TEAM_4 "}},
}
local msg_id = msg.id_/2097152/0.5
...
if DevBLACK(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/telethon-Arab/TEAMBLACK_Files/main/gitfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/telethon-Arab/TEAMBLACK_Files/main/File_Bot/"..file)
if res == 200 then
...
data = JSON.decode(url)
if data.ChatMember.TEAMBLACK ~= true then
local Text = '⌔︙ عليك الاشتراك في قناة البوت **\n**⌔︙قناة البوت ↫  @BLACK_TEAM_4'
keyboard = {} 
keyboard.inline_keyboard = { 
{{text = '★ اشترك الان   ',url="t.me/BLACK_TEAM_4"}},  
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false 
...
keyboard.inline_keyboard = {
{
{text = '⌔┇ 𝗍𝖾𝖺𝗆 black ',url="https://t.me/BLACK_TEAM_4"},
},
{
{text = '⌔┇ 𝖼𝗁⁦  ',url="https://t.me/UU_KFUF"},
},
{
{text = '⌔┇ 𝖽𝖾𝗏',url="t.me/UUOUOU_7"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
⌔┇𝗌𝗈𝗎𝗋𝖼𝖾 𝗍𝖾𝗅𝖾𝗍𝗁𝗈𝗇 𖤍
— — — — — — — — —
⚙️ | 𝗐𝖾𝗅𝖼𝗈𝗆𝖾 𝗍𝗈 𝗍𝖾𝖺𝗆 black 𝄮 
★ | 𝗁𝖾𝗅𝗅𝗈 𝖽𝖾𝖺𝗋 𝗂𝗇 𝖻𝗈𝗍 𝗈𝗋𝖽𝖾𝗋𝗌 †
♪ | 𝗍𝗁𝖾 f𝗈𝗅𝗅𝗈𝗐𝗂𝗇𝗀 𝗉𝗋𝗈𝗍𝖾𝖼𝗂𝗍𝗈𝗆 𝖼𝗈𝗆𝗆𝖺𝗇𝖽𝗌 𖠛
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
send(msg.chat_id_,msg.id_,'⌔┇ تم التحديث')
os.execute('rm -rf TEAMBLACK.lua')
os.execute('rm -rf startTelethon.lua')
os.execute('wget https://raw.githubusercontent.com/telethon-Arab/TEAMBLACK/master/TEAMBLACK.lua')
os.execute('wget https://raw.githubusercontent.com/telethon-Arab/TEAMBLACK/master/startTelethon.lua')
dofile('TEAMBLACK.lua')  
...
database:set(bot_id.."BLACK:Lock:text"..data.chat_id_,true) 
...
local Num_Games = database:get(bot_id.."BLACK:Add:Num"..data.chat_id_..data.sender_user_id_) or 0
...
local Teext =[[
𝙬𝙚𝙡𝙘𝙤𝙢𝙚 𝙩𝙤 𝙨𝙤𝙪𝙧𝙘𝙚 [⌔┇𝗍𝖾𝖺𝗆 black](t.me/BLACK_TEAM_4) 
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
inline = {
{{text = '⌔┇ 𝗍𝖾𝖺𝗆 black .',url='http://t.me/BLACK_TEAM_4'}},
}
